      PROGRAM ZUT_99_11                                                 UT    10
C     (REPORT: JUEL - 4348, JAN. 2012)                                  UT    20
C     (REPORT: JUEL - 4326, JUNE 2010)                                  UT    21
C                                                                       UT    30
...
C                                                                       UT   840
      ...
      OPEN(30,ACCESS='DIRECT',RECL=292,FILE='Libraries\resint')         UT   910
C                                                                       UT   920
...
C                                                                       UT  1380
      M9 = 9                                                            UT  1390
C     SPEICHERLOESCHUNG FUER DEN COMMON-BEREICH                         UT  1400
C                                                                       UT  1410
C                                                                       UT  1420
      NLESEN=0                                                          UT  1430
  700 EE = 0.                                                           UT  1440
      ...
      XONE=0.                                                           UT  2430
      ZONE=0.                                                           UT  2440
      IF(NLESEN.GT.0) GOTO 603                                          UT  2450
c     DO 2 I=1,36                                                       UT  2460
c       EE(I) = 0.                                                      UT  2470
c   2 CONTINUE                                                          UT  2480
C     IJK = 0                                                           UT  2490
C 600 IJK = IJK + 1                                                     UT  2500
C     U(IJK) = 0                                                        UT  2510
C     IF(IJK-21128) 600,601,601                                         UT  2520
  601 CONTINUE                                                          UT  2530
C                                                                       UT  2540
C     Z U T - RESOLVED RESONANCE ABSORPTION CALCULATION - G.F.KUNCIR    UT  2550
C     MAIN PROCESSING PROGRAM                                           UT  2560
C     ERSTE COMMON- UND DIMENSIONKARTE NUR ZUR SPEICHERLOESCHUNG        UT  2570
C     BEI MEHREREN FAELLEN HINTEREINANDER                               UT  2580
C                                                                       UT  2590
C     STORAGE ALLOCATION CONSTANTS                                      UT  2600
C     ITEMS PER RESOLVED RESONANCE PARAMETER SET                        UT  2610
C                                                                       UT  2620
C     AENDERUNG IN DER REIHENFOLGE DER EINGABEDATEN (FOLGEFAELLE)       UT  2630
C     (GILT NUR FUER RESONANZDATEN VON KARTE)                           UT  2640
C     -----------------------------------------------------------       UT  2650
C     1.) TEXT-KARTE                                                    UT  2660
C     2.) KARTEN MIT DEN RESONANZEN EZERO(I)                            UT  2670
C     3.) LEERKARTE                                                     UT  2680
C     DIE UEBRIGEN DATENKARTEN FOLGEN IN DER BISHERIGEN REIHENFOLGE.    UT  2690
C     NACH JEDEM FALL IST EINE KARTE MIT "8" IN COL.1 ANZUFUEGEN.       UT  2700
C     DIE RESONANZDATEN BRAUCHEN (FALLS GLEICHBLEIBEND) NICHT NOCH EIN- UT  2710
C     MAL EINGEGEBEN WERDEN (SIE SIND AUF DER UNIT 8 GESPEICHERT).      UT  2720
C                                                                       UT  2730
C     HERSTELLUNG VON UNIT 8                                            UT  2740
C                                                                       UT  2750
 5020 CONTINUE                                                          UT  2760
C                                                                       UT  2770
      READ (N5,640) IEND,JI,KI,(FIELD(LI),LI=1,KI)                      UT  2780
      IF(KI.GT.0) GOTO 112                                              UT  2790
      DO 111 I=1,5                                                      UT  2800
      FIELD(I) = 0.                                                     UT  2810
  111 CONTINUE                                                          UT  2820
  112 CONTINUE                                                          UT  2830
C                                                                       UT  2840
      IF(JI .EQ. -30) JII = JI                                          UT  2850
C                                                                       UT  2860
      IF(IEND .EQ. 9) CALL EINGA9(MODE,MODE1)                           UT  2870
C                                                                       UT  2880
      IF(NNRESO .EQ. 0) GOTO 6001                                       UT  2890
      JEND = IEND                                                       UT  2900
C                                                                       UT  2910
      CALL RESODA(IZAEHL,JEND)                                          UT  2920
C                                                                       UT  2930
      IEND = JEND                                                       UT  2940
      IF(IWOHIN .LT. 0) GOTO 5020                                       UT  2950
 6001 CONTINUE                                                          UT  2960
      IF(JI .EQ. -30) FUTYP = FIELD(1)                                  UT  2970
      IF(FUTYP .GT. 0.) FTYP = FUTYP                                    UT  2980
      IF(IEND .NE. 6) GOTO 5019                                         UT  2990
C                                                                       UT  3000
      CALL TUZ                                                          UT  3010
C                                                                       UT  3020
      GOTO 5020                                                         UT  3030
 5019 CONTINUE                                                          UT  3040
      IF(FUTYP .LE. 0.) GOTO 5023                                       UT  3050
      MFUTP = IFIX(FUTYP)                                               UT  3060
      II = MFUTP + 1                                                    UT  3070
      IF(MFUTP .LE. 100) GOTO 5025                                      UT  3080
      NXT29 = 2                                                         UT  3090
      READ (NEI29,REC=NXT29) N30,(NFT(I),I=1,N30)                       UT  3100
      DO 5024 I=1,N30                                                   UT  3110
        II = I                                                          UT  3120
        IF(MFUTP .EQ. NFT(I)) GOTO 5025                                 UT  3130
 5024 CONTINUE                                                          UT  3140
      WRITE (M6,503) MFUTP                                              UT  3150
      STOP                                                              UT  3160
 5025 CONTINUE                                                          UT  3170
      NXT29 = II                                                        UT  3180
      READ (NEI29,REC=NXT29) NISO,(NRMAF(I),DEN(I),I=1,NISO),(DATA(I),I=UT  3190
     1 1,14),NFU,NVR,(IMA(NRMAF(I)),I=1,NISO)                           UT  3200
      WRITE (M6,504) NFU,NVR                                            UT  3210
      FUTYP = 0.                                                        UT  3220
 5023 CONTINUE                                                          UT  3230
      IF(NGAM .GT. 0 .OR. JI .GE. 0) GOTO 5021                          UT  3240
      NGAM = IABS(JI)                                                   UT  3250
      IDSA = 0                                                          UT  3260
      IF(JII .NE. -30) GOTO 5026                                        UT  3270
      IDSATZ = -180                                                     UT  3280
      IDNUCL = 170                                                      UT  3290
      GOTO 5027                                                         UT  3300
 5026 CONTINUE                                                          UT  3310
      READ (5,5022) IDSATZ,IDNUCL,(LOESCH(LO),LO=2,9)                   UT  3320
      LOESCH(1) = 0                                                     UT  3330
 5027 CONTINUE                                                          UT  3340
      IF(IDSATZ .GT. 0) IDENT = 180                                     UT  3350
      DENHOM = 0.                                                       UT  3360
      IF(NNDATA .LE. 0.) GOTO 301                                       UT  3370
      DO 300 I=1,NISO                                                   UT  3380
        IF(IDNUCL .NE. IMA(NRMAF(I))) GOTO 300                          UT  3390
        DENHOM = DEN(I)                                                 UT  3400
  300 CONTINUE                                                          UT  3410
  301 CONTINUE                                                          UT  3420
      IF(IDSATZ .GT. 0) IDSA = IDSATZ                                   UT  3430
      IDSATZ = IABS(IDSATZ)                                             UT  3440
      IF(LOESCH(1) .EQ. 0 .AND. IDSA .GT. 0) LOESCH(1) = IDSA           UT  3450
      IF(NGAM .NE. NEI25) GOTO 2000                                     UT  3460
      LENNNR = IDENT                                                    UT  3470
      IFALNR = IDSATZ                                                   UT  3480
      NUCLID = IDNUCL                                                   UT  3490
      DO 2501 LO=1,9                                                    UT  3500
        LOPUTZ(LO) = LOESCH(LO)                                         UT  3510
 2501 CONTINUE                                                          UT  3520
C                                                                       UT  3530
C     VORBEREITUNG EINER GAM-GRUPPEN-LIBRARY                            UT  3540
C                                                                       UT  3550
      CALL GRUGA                                                        UT  3560
C                                                                       UT  3570
      IGRUG = IGRUG + 1                                                 UT  3580
      NGAM = 0                                                          UT  3590
      IDNUCL = 0                                                        UT  3600
      GOTO 5020                                                         UT  3610
 2000 CONTINUE                                                          UT  3620
      IF(IDENT .GT. 0) GOTO 5020                                        UT  3630
      IDENT = IABS(IDENT)                                               UT  3640
C                                                                       UT  3650
      CALL GAMDAT(IDENT,IDSATZ,IDNUCL,NGAM,M6)                          UT  3660
C                                                                       UT  3670
      NGAM = 0                                                          UT  3680
      GOTO 5020                                                         UT  3690
 5021 CONTINUE                                                          UT  3700
      IF(IEND .EQ. 9) GOTO 5020                                         UT  3710
      IF(IEND .GT. 0) IRESRE = IRESRE + 1                               UT  3720
      WRITE (8,640) IEND,JI,KI,(FIELD(LI),LI=1,KI)                      UT  3730
      IF(IEND) 5020,5030,5020                                           UT  3740
 5030 CONTINUE                                                          UT  3750
  999 IRSV = 9                                                          UT  3760
      IDEN(1) = 1                                                       UT  3770
      REWIND 8                                                          UT  3780
C                                                                       UT  3790
C     ITEMS PER RESONANCE CONFIGURATION SET                             UT  3800
C                                                                       UT  3810
      ICON = 8                                                          UT  3820
C                                                                       UT  3830
C     MAXIMUM INDEPENDENT RESOLVED RESONANCE PARAMETER SETS             UT  3840
C                                                                       UT  3850
      MRSV = 500                                                        UT  3860
C                                                                       UT  3870
C     MAXIMUM INDEPENDENT RESONANCE CONFIGURATION SETS                  UT  3880
C                                                                       UT  3890
      MCON = 50                                                         UT  3900
C                                                                       UT  3910
C     MAXIMUM ACCEPTABLE INPUT SETS                                     UT  3920
C                                                                       UT  3930
      MAIM = 1000                                                       UT  3940
C                                                                       UT  3950
C     MAXIMUM MESH SIZE                                                 UT  3960
C                                                                       UT  3970
      MMSH = 501                                                        UT  3980
C                                                                       UT  3990
C     MAXIMUM INTEGRATION BACK VALUES                                   UT  4000
C                                                                       UT  4010
      MIBV = 1001                                                       UT  4020
C                                                                       UT  4030
C     SET FORTRAN LOGICAL UNIT DESIGNATIONS                             UT  4040
C                                                                       UT  4050
      NINP = 5                                                          UT  4060
      NOUT = 6                                                          UT  4070
      NOXT = 10                                                         UT  4080
      UNIT(1) = FCP017                                                  UT  4090
      NNXT = 11                                                         UT  4100
      UNIT(2) = FCP018                                                  UT  4110
C                                                                       UT  4120
C     SET UNIT IDENTIFICATION WORDS                                     UT  4130
C                                                                       UT  4140
      TFLAG(1) = FCP019                                                 UT  4150
      TFLAG(2) = FCP020                                                 UT  4160
      TFLAG(3) = FCP021                                                 UT  4170
      TFLAG(4) = FCP022                                                 UT  4180
...
C                                                                       UT  4270
   ...
   30 CONTINUE                                                          UT  4310
C                                                                       UT  4320
C     REWIND NNXT                                                       UT  4330
C                                                                       UT  4340
   40 IF(IDEN(1)) 50,50,60                                              UT  4350
   50 REWIND NOXT                                                       UT  4360
C                                                                       UT  4370
C     IDENTIFY UNIT NOXT, READ UNIT NOXT RESOLVED RESONANCE INDEX       UT  4380
C                                                                       UT  4390
      CALL TIDIX(1)                                                     UT  4400
C                                                                       UT  4410
C     READ AND STORE INPUT, PREPARE SEQUENCE INDICES                    UT  4420
C                                                                       UT  4430
   60 CALL INPUT                                                        UT  4440
C                                                                       UT  4450
      IF(NEND .EQ. 5) CALL STUEZP                                       UT  4460
C                                                                       UT  4470
      IF(ITUZ .EQ. 0) GOTO 9                                            UT  4480
C                                                                       UT  4490
      CALL TUTS                                                         UT  4500
C                                                                       UT  4510
    9 CONTINUE                                                          UT  4520
      IF(IRESRE .EQ. 0) GOTO 181                                        UT  4530
      IF(NAIN) 200,200,70                                               UT  4540
C                                                                       UT  4550
C     COMPUTE MESH NEEDED FOR CROSS SECTION SETS                        UT  4560
C                                                                       UT  4570
   70 CALL GRID                                                         UT  4580
C                                                                       UT  4590
C     PRINT UNIT CONDITIONS, WRITE UNIT NNXT IDENTIFICATION AND INDEX   UT  4600
C                                                                       UT  4610
      CALL TIDIX(2)                                                     UT  4620
C                                                                       UT  4630
C     RESOLVED RESONANCE CROSS SECTION GENERATION LOOP                  UT  4640
C                                                                       UT  4650
      K = 1                                                             UT  4660
      DO 180 L=1,IRVN                                                   UT  4670
        I = INDEX(L,3)                                                  UT  4680
        IF(I-IRVO) 80,80,110                                            UT  4690
   80   IF(AZERO(I)) 90,90,100                                          UT  4700
C                                                                       UT  4710
C     SKIP UNIT NOXT RECORD                                             UT  4720
C                                                                       UT  4730
   90   READ (NOXT)                                                     UT  4740
        GOTO 180                                                        UT  4750
C                                                                       UT  4760
C     READ UNIT NOXT CROSS SECTION RECORD                               UT  4770
C                                                                       UT  4780
  100   READ (NOXT) DATE(1),DATE(2),IM,(AMU(M+2),SIGAZ(M+2),SIGSZ(M+2),MUT  4790
     1   =1,IM)                                                         UT  4800
        GOTO 130                                                        UT  4810
C                                                                       UT  4820
C     COMPUTE RESOLVED RESONANCE CROSS SECTION DATA                     UT  4830
C                                                                       UT  4840
  110   IF(MMSH-MESH(I)) 180,120,120                                    UT  4850
  120   CONTINUE                                                        UT  4860
C                                                                       UT  4870
        CALL CROSS                                                      UT  4880
C                                                                       UT  4890
C     WRITE UNIT NNXT CROSS SECTION RECORD                              UT  4900
C                                                                       UT  4910
  130   IF(IDEN(2)) 140,140,170                                         UT  4920
  140   IF(I-IRVO) 150,150,160                                          UT  4930
  150   CONTINUE                                                        UT  4940
  160   CONTINUE                                                        UT  4950
C                                                                       UT  4960
C     CALCULATE RESOLVED RESONANCE INTEGRALS AND WING CORRECTIONS       UT  4970
C                                                                       UT  4980
  170   CALL RESOL                                                      UT  4990
C                                                                       UT  5000
  180 CONTINUE                                                          UT  5010
  181 CONTINUE                                                          UT  5020
C                                                                       UT  5030
C     VERBUCHEN AUF GAM-GRUPPEN-LIBRARY                                 UT  5040
C                                                                       UT  5050
      IF(IFALNR .NE. 0) CALL GRUGA3                                     UT  5060
C                                                                       UT  5070
      IF(IRESRE .EQ. 0) CALL TERMINAT                                   UT  5080
      IF(IDEN(1)+IDEN(2)-2) 190,240,240                                 UT  5090
C                                                                       UT  5100
C     CALCULATE TOTAL RESOLVED RESONANCE INTEGRALS                      UT  5110
C                                                                       UT  5120
  190 CALL TOTAL                                                        UT  5130
C                                                                       UT  5140
C     END OF CALCULATION                                                UT  5150
C                                                                       UT  5160
  200 IF(IDEN(1)) 210,210,220                                           UT  5170
  210 REWIND NOXT                                                       UT  5180
  220 IF(IDEN(2)) 230,230,240                                           UT  5190
  230 CONTINUE                                                          UT  5200
C                                                                       UT  5210
C     END FILE NNXT, REWIND NNXT                                        UT  5220
C                                                                       UT  5230
  240 IF(IEND-4) 260,250,260                                            UT  5240
  250 I = 2                                                             UT  5250
  260 CONTINUE                                                          UT  5260
C                                                                       UT  5270
C     SPEICHERLOESCHUNG FUER DEN NAECHSTEN FALL                         UT  5280
C                                                                       UT  5290
      NLESEN=1                                                          UT  5300
      GOTO 700                                                          UT  5310
C                                                                       UT  5320
C     IJK = 0                                                           UT  5330
C 602 IJK = IJK + 1                                                     UT  5340
C     U(IJK) = 0.                                                       UT  5350
...
C                                                                       UT  5400
      ...
      GOTO 999                                                          UT  5420
  501 WRITE (NOUT,502)                                                  UT  5430
      CALL TERMINAT                                                     UT  5440
      END                                                               UT  5450
      SUBROUTINE INPUT                                                  NPU   10
C                                                                       NPU   20
      DIMENSION W(20),U(6),RRR(5),FX(5),DATA(31),FIELD(10),DATE(2),     NPU   30
...
C                                                                       COV  220
   ...
   20 FORMAT (//////37X,'**',5X,'**',7X,7('*'),8X,7('*'),7X,8('*')/37X,'COV  380
     ...
     5 3X,'**',2X,'**',9X,'**')                                         COV  430
   30 FORMAT (//////////17X,'JAN. 2012',64X,'REPORT: V.S.O.P.(99/11)'/99COV  440
     1X,'JUEL - 4348'/17X,'JUNE 2010',64X,'REPORT: V.S.O.P.(99/09)'/99X,COV  450
     2 'JUEL - 4326'/99X,'SECTION 5.2')                                 COV  451
...
C                                                                       GRI   20
      DIMENSION W(20),U(6),RRR(5),FX(5),DATE(2),FLAG(16),HEAD(24),      GRI   30
     1IDEN(2),IVAL(3),MESH(500),REASON(32),TFLAG(16),UNIT(2),AZERO(500) GRI   40
...
C                                                                       GRI  410
   ...
   70   R(IG) = 0.                                                      GRI  530
     ...
     1   GAMMA(IG)                                                      GRI  550
C  80   EPSIL(IG) = 2. / AZERO(IG) / FLOAT(IFIX(0.5*(RP*SQRT(EZERO(IG)/ GRI  560
C    1   8.6164E-5/AZERO(IG)/273.0)+1.)))                               GRI  570
   80   RFX=0.5*(RP*SQRT(EZERO(IG)/8.6164E-5/AZERO(IG)/273.0)+1.)       GRI  580
        IFX = IFIX(RFX)                                                 GRI  590
        FFX = FLOAT(IFX)                                                GRI  600
        EPSIL(IG) = 2. /AZERO(IG) / FFX                                 GRI  610
C                                                                       GRI  620
        SIGOH(IG) = 2.6E6 * G(IG) * GAMN(IG) / EZERO(IG) / GAMMA(IG)    GRI  630
        XONE = S(IG) * SQRT(SIGOH(IG)/SIGPZ(IG))                        GRI  640
        XI(IG) = GAMMA(IG) / 2. / SQRT(8.6164E-5*EZERO(IG)*TEMP(IG)/    GRI  650
     1   AZERO(IG))                                                     GRI  660
        IF(10./XI(IG)-XONE/2.) 100,100,120                              GRI  670
  100   EONE(IG) = EZERO(IG) + GAMMA(IG) * XONE / 2.                    GRI  680
        GOTO 140                                                        GRI  690
  120   EONE(IG) = EZERO(IG) + 10. * GAMMA(IG) / XI(IG)                 GRI  700
  140   ZONE = (EONE(IG)-EZERO(IG)) / EZERO(IG)                         GRI  710
        IF(ZONE-0.57142857E0) 160,160,180                               GRI  720
  160   MESH(IG) = 1 + 2 * IFIX(0.5*(ALOG(EONE(IG)/(2.*EZERO(IG)-       GRI  730
     1   EONE(IG)))/EPSIL(IG)+1.))                                      GRI  740
        EONE(IG) = 2. * EZERO(IG) / (1.+EXP(-EPSIL(IG)*FLOAT(MESH(IG)-1)GRI  750
     1   ))                                                             GRI  760
        GOTO 200                                                        GRI  770
CFZJ065                                                                 GRI  780
  180   MESH(IG) = 1 + 2 * IFIX(0.5*(ALOG((5./3.)*EONE(IG)/EZERO(IG))/  GRI  790
     1   EPSIL(IG)+1.))                                                 GRI  800
        EONE(IG) = EZERO(IG) * EXP(EPSIL(IG)*FLOAT(MESH(IG)-1)) /       GRI  810
     1   (5./3.)                                                        GRI  820
  200   IF(MMSH-MESH(IG)) 220,320,320                                   GRI  830
C                                                                       GRI  840
C     MESH EXCEEDS STORAGE LIMITS                                       GRI  850
C                                                                       GRI  860
  220   CONTINUE                                                        GRI  870
        NG = 1                                                          GRI  880
        IEXM = IEXM + 1                                                 GRI  890
        WRITE (NOUT,361) EZERO(IG),R(IG),RP,MESH(IG)                    GRI  900
  240   MG = INDEX(KG,2)                                                GRI  910
C                                                                       GRI  920
        CALL TITLE(11,REASON)                                           GRI  930
C                                                                       GRI  940
        GOTO(260,280,300),NG                                            GRI  950
C                                                                       GRI  960
C     PRINT SETS WHICH REQUIRE MESH EXCEEDING THE STORAGE LIMITS        GRI  970
C                                                                       GRI  980
  260   CALL PAGE(NG,0,7)                                               GRI  990
C                                                                       GRI 1000
        WRITE (NOUT,340) (HEAD(NG),NG=1,4),(HEAD(NG),NG=13,24)          GRI 1010
        WRITE (NOUT,360)                                                GRI 1020
C                                                                       GRI 1030
  280   CALL PAGE(NG,2,6)                                               GRI 1040
C                                                                       GRI 1050
        WRITE (NOUT,380)                                                GRI 1060
        WRITE (NOUT,340) (REASON(NG),NG=1,12)                           GRI 1070
C                                                                       GRI 1080
  300   CALL PAGE(NG,7,11)                                              GRI 1090
C                                                                       GRI 1100
        WRITE (NOUT,380)                                                GRI 1110
        WRITE (NOUT,400) AZERO(IG),G(IG),SIGPZ(IG),TEMP(IG),EZERO(IG),  GRI 1120
     1   GAMN(IG),GMGM(IG),R(IG),S(IG),SOLVE(MG),ABAR(MG),C(MG),        GRI 1130
     2   DZERO(MG),AMOD1(MG),SIGM1(MG),AMOD2(MG),SIGM2(MG)              GRI 1140
  320 CONTINUE                                                          GRI 1150
      RETURN                                                            GRI 1160
C                                                                       GRI 1170
  340 FORMAT (3H   ,16A3)                                               GRI 1180
  360 FORMAT (52H0  ** THE FOLLOWING INPUT SETS WERE NOT PROCESSED **)  GRI 1190
  361 FORMAT (' FOR THE FOLLOWING RESONANCE ARE  EZERO(IG),R(IG),RP,MESHGRI 1200
     1(IG)  EQUAL:'/3E15.6,I6)                                          GRI 1210
  380 FORMAT (1H )                                                      GRI 1220
  400 FORMAT (119H0        A ZERO            G   SIG P ZERO         TEMPGRI 1230
     1       E ZERO      GAMMA N  GAMMA GAMMA            R            S/GRI 1240
     2 2H  ,9(1PE13.5)/119H0      SOLUTION                     A BAR    GRI 1250
     3        C       N ZERO       A MOD1     SIG MOD1       A MOD2     GRI 1260
     4SIG MOD2/2H  ,1PE13.5,13H             ,7(1PE13.5))                GRI 1270
      END                                                               GRI 1280
      SUBROUTINE CROSS                                                  CRO   10
C                                                                       CRO   20
      EXTERNAL SHAPE                                                    CRO   30
C                                                                       CRO   40
      DIMENSION W(20),U(6),RRR(5),FX(5),DATE(2),FLAG(16),HEAD(24),      CRO   50
     1IDEN(2),IVAL(3),MESH(500),REASON(32),TFLAG(16),UNIT(2),AZERO(500) CRO   60
...
C                                                                       TID   20
      DIMENSION W(20),U(6),RRR(5),FX(5),DATE(2),FLAG(16),HEAD(24),      TID   30
     1IDEN(2),IVAL(3),MESH(500),REASON(32),TFLAG(16),UNIT(2),AZERO(500) TID   40
...
C                                                                       RES   40
      DIMENSION W(20),U(6),RRR(5),FX(5),EXTRA(8),DATE(2),FLAG(16),      RES   50
...
C                                                                       RES  410
C     COMPUTES RESOLVED RESONANCE INTEGRAL                              RES  420
...
C                                                                       GAU   20
      DIMENSION U(6),RRR(5),FX(5)                                       GAU   30
C                                                                       GAU   40
...
C                                                                       PAG   20
      DIMENSION W(20),U(6),RRR(5),FX(5),DATE(2),FLAG(16),HEAD(24),      PAG   30
...
C                                                                       SHA   20
      DIMENSION W(20),U(6),RRR(5),FX(5),DATE(2),FLAG(16),HEAD(24),      SHA   30
     1IDEN(2),IVAL(3),MESH(500),REASON(32),TFLAG(16),UNIT(2),AZERO(500) SHA   40
